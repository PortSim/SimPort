...
import com.group7.ByTypeIconProvider
...
class SimulationState(val scenario: Scenario, iconProvider: IconProvider = ByTypeIconProvider()) : MetricReporter {
    private var isBatching = false
    private var lastUpdateTime = Instant.DISTANT_PAST

    private val metricsTracker = MetricsTracker(scenario)
